    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <div className="pt-24 pb-16 px-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-zinc-400 leading-relaxed text-sm">
          <p>
            Welcome to Aegis. By accessing or using our platform, you agree to be bound by these Terms of Service.
          ...
          <p>
            By creating an account, participating in tournaments, or using the Aegis platform, you agree to comply with and be bound by these Terms.
          </p>

          <h2 className="text-xl font-bold text-white uppercase mt-8 mb-4">2. User Conduct & Fair Play</h2>
          <p>
            Aegis is dedicated to fostering a fair and competitive environment. Any form of cheating, hacking, smurfing (where explicitly prohibited), or toxic behavior is strictly forbidden and may result in an immediate and permanent ban from the platform.
          </p>
          ...
          <p>
            Aegis is an independent esports platform. We are not affiliated with, endorsed by, or sponsored by Riot Games, Krafton, or any other game publisher. All game-related assets, trademarks, and copyrights belong to their respective owners.
          </p>

          <h2 className="text-xl font-bold text-white uppercase mt-8 mb-4">5. Account Security</h2>
          <p>
            You are responsible for maintaining the confidentiality of your account credentials. Aegis is not liable for any loss or damage arising from unauthorized access to your account.
          </p>
