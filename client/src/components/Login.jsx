...
const AegisLogin = () => {
  ...
  const handleGoogleLogin = async () => {
    // Note: You need to import and configure firebase auth properly
          ...
          <div className="w-full max-w-md space-y-8 bg-black/20 backdrop-blur-md p-8 rounded-2xl border border-white/10">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="block text-sm font-semibold text-gray-300">I am logging in as...</label>
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() => setFormData(prev => ({ ...prev, role: 'player' }))}
                    className={`p-3 rounded-xl border-2 transition-all duration-300 flex items-center justify-center space-x-2 hover:scale-105 ${formData.role === 'player'
                  ...
                  <button
                    ...
                    className={`p-3 rounded-xl border-2 transition-all duration-300 flex items-center justify-center space-x-2 hover:scale-105 ${formData.role === 'organization'
                      ? 'border-blue-500 bg-blue-500/20 text-white shadow-lg shadow-blue-500/30'
                      : 'border-gray-600/50 bg-gray-900/30 text-gray-300 hover:border-gray-500/70'
                      }`}
                  >
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full pl-16 pr-6 py-4 bg-gray-900/30 backdrop-blur-sm border-2 rounded-xl text-white text-lg placeholder-gray-400 focus:outline-none focus:ring-4 transition-all duration-300 ${errors.email
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full pl-16 pr-16 py-4 bg-gray-900/30 backdrop-blur-sm border-2 rounded-xl text-white text-lg placeholder-gray-400 focus:outline-none focus:ring-4 transition-all duration-300 ${errors.password
                    ? 'border-red-500/50 focus:ring-red-500/20 focus:border-red-400'
                    : 'border-gray-600/50 focus:ring-blue-500/20 focus:border-blue-400 hover:border-gray-500/70'
                    }`}
                />
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-3 cursor-pointer group">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`w-5 h-5 rounded border-2 transition-all duration-200 ${rememberMe
