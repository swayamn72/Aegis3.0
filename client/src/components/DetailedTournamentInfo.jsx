                  ...
                  <div className="flex gap-2">
                    {tournamentData?.phases?.map((phase) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium transition-colors ${selectedPhase === phase.name ? 'bg-orange-500 text-white' : 'bg-zinc-700 text-zinc-300 hover:bg-zinc-600'
                          }`}
                      >
                        {phase.name}
                      </button>
